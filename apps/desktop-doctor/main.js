...
const DEV_SCRIPT = process.env.ICARE_DEV_SCRIPT || "dev:doctor";
const DEFAULT_URL = process.env.ICARE_DOCTOR_URL || "http://127.0.0.1:5175";
const APP_TITLE = "ICare - Doctor";
